***Для компании PropDevelopment были выбраны следующие разделы проверочного листа:***
...
Интеграции с управляющими компаниями (риск утечек).

Активное развитие партнерских сервисов (нужны безопасные API).

Что проверяем:

Аутентификация API, валидация данных, мониторинг использования.

5. **Разработка и эксплуатация приложений**

   Почему выбран:

Ошибки в приложениях (клиенты видят чужие данные).

Нет проверок безопасности в процессе разработки.

Планируются новые сервисы (нужны безопасные практики разработки).

Что проверяем:

Защита от XSS/SQL-инъекций, тестирование на проникновение.
